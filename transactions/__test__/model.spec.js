...
import { TransactionNotFoundError } from "../errors/transaction-not-found.erro.js";
import { TransactionUidNotInformedError } from "../errors/transaction-uid-not-informed.erro.js";
...
describe("Transaction model", () => {
    ...
    describe("give find user by uid", () => {
        ...
        describe("given update transaction", () => {
            ...
            test("then return update transaction", async () => {
                ...
                expect(model).toEqual(updateTransaction)
            });
        ...
        describe("given delete transaction", () => {
            ...
            test("when seccess, then delete transaction", async () => {
                const model = new Transaction(repositoryMock);
                model.uid = "anyUid"
                model.user = { uid: "anyUserUid" };
